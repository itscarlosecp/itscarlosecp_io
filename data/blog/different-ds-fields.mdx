...
image: 'https://firebasestorage.googleapis.com/v0/b/itscarlosecp-io.appspot.com/o/background.jpg?alt=media&token=ec340ddb-6f49-4358-b53c-67b983f3f441'
---

<Image
	alt='test'
	src={`https://firebasestorage.googleapis.com/v0/b/itscarlosecp-io.appspot.com/o/background.jpg?alt=media&token=ec340ddb-6f49-4358-b53c-67b983f3f441`}
	width={720}
	height={720}
	priority
/>
...
1.  [Analysis vs. Analytics](/blog/different-ds-fields#analysis-vs-analytics)
2.  [Campos](/blog/different-ds-fields#campos)
    -   [Bussiness](/blog/different-ds-fields#bussiness)
    -   [Data](/blog/different-ds-fields#data)
3.  [Otros Campos](/blog/different-ds-fields#otros-campos)
