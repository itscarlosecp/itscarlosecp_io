...
Sin embargo no estamos limitados a la funcionalidad que nos provea esta librería. Podemos utilizar las funcionalidad propias de Auth0 para modificar el funcionamiento de nuestro proceso de autenticación y autorización de cualquier manera, a nuestro gusto, como cambiar la base de datos, o crear rules que se ejecuten como serverless functions tras la autenticación de un usuario, entre muchas otras opciones.
