...
<Callout>
	...
	haber ingresado bien los campos. Podemos intentar repetir el{' '}
	<a href='#generación-de-token-temporal'>paso</a> en el que conseguimos el{' '}
	<code>TOKEN_TEMPORAL</code> a través el URL, ya que puede ser que esta haya
	vencido.
</Callout>
