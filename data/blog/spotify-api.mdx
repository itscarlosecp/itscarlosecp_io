...
NextJS es un framework basado en React, que nos facilita la creación de aplicaciones web o "single page applications". Está pensado para mejorar el rendimiento, seguridad y SEO de nuestra aplicaciones, así como también la experiencia de desarrollo. Entre otra de sus ventajas está la cercana integración de frontend y backend, ya que NextJS nos permite construir serverless functions que funcionan a manera de backend, directamente desde nuestra aplicación.
...
-   **response_type:** Este valor corresponde al tipo de respuesta que queremos que la autenticación inicial nos devuelva. En este caso el valor de este parámetro va a ser el valor `code`.
