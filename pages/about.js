...
const about = ({ topTracks }) => {
	return (
		<>
			...
			<p className='mb-2 prose dark:prose-dark text-gray-600 dark:text-gray-400'>
				I would describe myself as a creative person, someone who is
				passionate about development, mostly web user interfaces. I'm
				also interested in math, science and sharing my knowledge with
				others.
			</p>
			<div className='mb-2 prose text-gray-600 dark:text-gray-400'>
				<ul>
					<li>🚧 Working on my personal blog.</li>
					<li>💾 Talk to me about tech, that's what I love, tech.</li>
				</ul>
			</div>
			...
			<p className='mb-4 prose text-gray-600 dark:text-gray-400'>
				I unlock my full "developer potencial" when I am listening to
			...
			<ul className='w-full flex flex-col divide-y divide-gray-100 dark:divide-gray-800 mb-16'>
			...
			<p className='mb-2 prose text-gray-600 dark:text-gray-400'>
				These are the gadgets and technologies I use on a day to day
